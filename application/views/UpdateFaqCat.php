           ...
           <div class="col-md-3"></div>
            <div class="col-md-6 grid-margin stretch-card">
                ...
                <div class="card-body">
                  ...
                  <h1 class="template-demo">Update FAQ Category</h1>
                  </div>
                  <form id="FaqCatform" class="forms-sample" method="post" action="<?php echo base_url(); ?>/index.php/FaqCatController/Update/<?php echo $FaqCatData[0]->FaqCatId; ?>">
                    <div class="form-group">
                      <label>FAQ Cat Name</label>
                      <input value="<?php echo $FaqCatData[0]->FaqCatName; ?>" type="text" class="form-control"  name="txtFaqCatName"  placeholder="Faq Name" />
                    </div>
