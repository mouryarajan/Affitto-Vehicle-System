 ...
 $(document).ready(function(){
  ...
  $('#order-listing').on('click', '.btndelete', function() {
     ...
     <?php
            ...
            <div class="row">
                <div class="col-6">
                <h1 class="template-demo">City Details</h1>
              </div>
                <div class="col-6"> <div style="text-align:right;"><a href="<?php echo base_url(); ?>index.php/CityController/LoadAddCity" class="btn btn-outline-success btn-fw"><i class="fa fa-plus">&nbsp;&nbsp;&nbsp;Add New City</i></a></div>
                </div>
              </div>
              <div class="row">
                <br>
                      ...
                      <?php
                        ...
                        {  ?>
                          <tr>
                            ...
                            <td><?php echo ucwords($item->CityName); ?></td>
                            <td>
                              <img style="width:100px;height:100px;" src="<?php echo base_url(); ?>/uploads/city/<?php echo ucwords($item->CityImg);?>"/>
                            </td>
                            <td><a style="padding: 0.6rem 2rem;" href="<?php echo base_url(); ?>index.php/CityController/edit/<?php echo $item->CityId; ?>" class="btn btn-outline-warning btn-rounded btn-fw"><i class="fa fa-edit">&nbsp;&nbsp;Update</i></a></td>

                            <td><a style="padding: 0.6rem 2rem;" href="#" data-id="<?php echo $item->CityId; ?>" data-toggle="modal" data-target="#exampleModal-3" class="btn btn-outline-danger btn-rounded  btn-fw btndelete"><i class="fa fa-trash-o">&nbsp;&nbsp;Delete</i></a></td>
                  ...
                  <div class="modal fade" id="exampleModal-3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-3" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>index.php/CityController/Delete">
                        <div class="modal-body">
                          <p>Are You Sure Want To Permanently Remove This City ?</p>
