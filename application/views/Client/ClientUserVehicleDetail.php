...
<div class="page-wrapper">
    ...
    <div id="page-content">
        <div class="container">
            ...
            <!--end page-title-->
            <a href="<?php echo base_url(); ?>index.php/Client/ClientUserVehicleListingController/LoadAddVehicleImage/<?php echo $VehicleDetail[0]->VehicleId; ?>" class="btn btn-primary btn-framed btn-rounded btn-light-frame icon scroll pull-right"><i class="fa fa-star"></i>Add More Images</a>
        </div>
        <!--end container-->
        <section>
            <div class="gallery detail">
                <div class="owl-carousel" data-owl-items="3" data-owl-loop="1" data-owl-auto-width="1" data-owl-nav="1" data-owl-dots="0" data-owl-margin="2" data-owl-nav-container="#gallery-nav">
                    <div class="image">
                        <div class="bg"><img src="<?php echo base_url(); ?>Client_Assets/ClientImage/VehicleImage/<?php echo $VehicleDetail[0]->VehicleImg;?>" alt="" /></div>
                    </div>
                    <?php 
                    ...
                    ?>
                    <div class="image">
                        <div class="bg"><img src="<?php echo base_url(); ?>Client_Assets/ClientImage/VehicleImage/<?php echo $item->ImageUrl;?>" alt="" /></div>
                    </div>
                    <?php } ?>
                </div>
                <!--end owl-carousel-->
