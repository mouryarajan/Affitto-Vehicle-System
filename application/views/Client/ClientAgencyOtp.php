            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-md-offset-4 col-sm-offset-4">
                    ...
                    <section>
                        ...
                        <form class="form inputs-underline" method="post" action="<?php echo base_url(); ?>index.php/Client/ClientAgencyRegistrationController/CheckOtp/<?php echo $insertid; ?>">
