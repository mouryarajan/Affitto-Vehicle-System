                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <section>
                        <div class="search-results-controls clearfix">
                            <div class="pull-left">
                                <a href="<?php echo base_url(); ?>index.php/Client/ClientUserVehicleListingController/LoadUserVehicleListing2" class="circle-icon active"><i class="fa fa-th"></i></a>
                                <a href="<?php echo base_url(); ?>index.php/Client/ClientUserVehicleListingController/LoadUserVehicleListing" class="circle-icon"><i class="fa fa-bars"></i></a>
                            </div>
                            <!--end left-->
                            <div class="pull-right">
                                <a href="<?php echo base_url(); ?>index.php/Client/ClientAddVehicleController/LoadAddVehicle" class="promoted">Add Vehicle</a> 
                            </div>
                            <!--end right-->
                        </div>
                                ...
                                <div class="item" data-id="1">
                                    <a href="./detail.html">
                                        <div class="description">
                                            ...
                                            <h3><?php echo $item->VehicleName; ?> </h3>
