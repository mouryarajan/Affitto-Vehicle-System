                ...
                <div class="col-md-9 col-sm-9">
                    ...
                    <section>
                        <div class="search-results-controls clearfix">
                            <div class="pull-left">
                                <a href="<?php echo base_url(); ?>index.php/Client/ClientCityListingController/LoadCity2" class="circle-icon"><i class="fa fa-th"></i></a>
                                <a href="<?php echo base_url(); ?>index.php/Client/ClientCityListingController/LoadCity" class="circle-icon active"><i class="fa fa-bars"></i></a>
                    ...
                    ?>
                        <div class="item item-row" data-id="1" data-latitude="40.72807182" data-longitude="-73.85735035">
                            <a href="<?php echo base_url(); ?>index.php/Client/ClientCityListingController/LoadCityVehicleListing/<?php echo $item->CityId; ?>">
                                <div class="image">
                                    <img style="height:150px; width:180px" src="<?php echo base_url(); ?>uploads/City/<?php echo ucwords($item->CityImg);?>" alt="" />
                                </div>
                                <!--end image-->
                                <div class="description">
                                    <h3><?php echo ucwords($item->CityName); ?></h3>
                                </div>
                                <!--end description-->
                            </a>
                            <!--end controls-more-->
