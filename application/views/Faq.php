...
<body>
 ...
 $(document).ready(function(){
  ...
  <?php
            ...
            <?php } ?>            <div class="row">
                <div class="col-6">
              <h1 class="template-demo">Faq Details</h1>
              </div>
                
                <div class="col-6">
                  <div style="text-align:right;"><a href="<?php echo base_url(); ?>index.php/FaqController/LoadAddFaq" class="btn btn-outline-success btn-fw"><i class="fa fa-plus">&nbsp;&nbsp;&nbsp;Add New Faq Categories</i></a></div>
                </div>
              </div>
              <div class="row">
                <br>
                     ...
                     <?php
                      ...
                      {?>
                          <tr>
                            ...
                            <td><?php echo ucwords($item->Question); ?></td>
                            <td><?php echo ucwords($item->Answer); ?></td>
                            <td><a style="padding: 0.6rem 2rem;" href="<?php echo base_url(); ?>index.php/FaqController/Edit/<?php echo $item->FaqId; ?>" class="btn btn-outline-warning btn-rounded btn-fw"><i class="fa fa-edit">&nbsp;&nbsp;Update</i></a></td>
                             <td>                      
                            <a href="#" style="padding: 0.6rem 2rem;" data-id="<?php echo $item->FaqId; ?>" data-toggle="modal" data-target="#exampleModal-3" class="btn btn-outline-danger btn-rounded  btn-fw btndelete"><i class="fa fa-trash-o">&nbsp;&nbsp;Delete</i></a>
                          </td>
                            </tr>
                        <?php
                        } 
                  ...
                  <div class="modal fade" id="exampleModal-3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-3" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>index.php/FaqController/Delete">
