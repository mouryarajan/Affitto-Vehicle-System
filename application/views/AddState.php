...
<head>
  ...
  <title>AFFITTO - State Project</title>
  <!-- plugins:css -->
...
<body>
  ...
  <script>
    $(function() {
      ...
      messages: {
        ...
        txtStateImg: {
          required: "*Please Enter a State Image",
  ...
  <?php
            ...
            <?php } ?>
                  ...
                  <h1 class="template-demo">Add New State</h1>
                  </div>
                  <div style="text-align: right;"><a id="btnsubmit" href="<?php echo base_url(); ?>index.php/StateController/LoadState" class="btn btn-outline-light btn-fw">View</a></div>
              
                  <form  id="StateForm" class="forms-sample cmxform" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>/index.php/StateController/AddState">
                 

                  <div class="form-group">
                      <label for="txtStateName">State Name</label>
                      <input  pattern="[a-zA-Z]{1,}"  requried="" type="text" class="form-control" id="txtStateName" name="txtStateName"  placeholder="StateName" />
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" required="" name="txtStateImg"  class="file-upload-default">
