   ...
   <?php
            ...
            <?php } ?>
              ...
              <h1 class="template-demo">Company Model Details</h1>
                ...
                <div class="col-6">
                  <div style="text-align:right;"><a href="<?php echo base_url(); ?>index.php/VersionController/LoadAddVersion" class="btn btn-outline-success btn-fw"><i class="fa fa-plus">&nbsp;&nbsp;&nbsp;Add New Model</i></a></div>
                </div>
              </div>
              <div class="row">
                <br>                
                     ...
                     <?php
                      ...
                      {?>
                          <tr>
                            ...
                            <td><a style="padding: 0.6rem 2rem;" href="<?php echo base_url(); ?>index.php/VersionController/Edit/<?php echo $item->VersionId; ?>" class="btn btn-outline-warning btn-rounded btn-fw"><i class="fa fa-edit">&nbsp;&nbsp;Update</i></a></td>
                            <td><a style="padding: 0.6rem 2rem;" href="#" data-id="<?php echo $item->VersionId; ?>" data-toggle="modal" data-target="#exampleModal-3" class="btn btn-outline-danger btn-rounded  btn-fw btndelete"><i class="fa fa-trash-o">&nbsp;&nbsp;Delete</i></a></td>
