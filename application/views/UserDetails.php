            ...
            <div class="col-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="d-flex justify-content-between">
                        <div>
                          <h3>  <?php echo $UserData[0]->FirstName; ?> <?php echo $UserData[0]->LastName; ?> </h3>
                          <div class="d-flex align-items-center">
                            <h5 class="mb-0 mr-2 text-muted"><?php echo $UserData[0]->CityName; ?> </h5>
             ...
             <div class="card-body">
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact-1" role="tab" aria-controls="contact-1" aria-selected="false">Contact Us</a>
                    </li>
                  </ul>
                    ...
                    <div class="tab-pane fade active show" id="home-1" role="tabpanel" aria-labelledby="home-tab">
                      <div class="media">
                       <div class="media-body">
                          ...
                          <img style="width: 147px;height:153px;" src="<?php echo base_url(); ?>Client_Assets/ClientImage/ClientProfile/<?php echo $UserData[0]->PersonalImage; ?>" class="rounded mw-100"/>
                          ...
                          <span class="float-right text-muted">
                          <?php echo $UserData[0]->PhoneNumber; ?>
                          </span>
                          <br><br>
                          ...
                          <span class="float-right text-muted">
                          <?php echo $UserData[0]->RegistrationDate ; ?>
                          </span>
                          <br><br>
                          ...
                          <?php echo $UserData[0]->AgencyAddress ; ?>
                          </span>
                          <br><br>
