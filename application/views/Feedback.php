 ...
 $(document).ready(function(){
  ...
  $('#order-listing').on('click', '.btndelete', function() {
     ...
     <?php
            ...
            <div class="row">
                <div class="col-6">
                  <h1 class="template-demo">Feedback</h1>
                </div>               
            </div>
              <div class="row">
                <br>
                     ...
                     <?php
                      ...
                      {?>
                          <tr>
                            ...
                            <td><?php echo ucwords($item->EmailId); ?></td>
                            <td><?php echo ucwords($item->Subject); ?></td>
                            <td><?php echo ucwords($item->Message); ?></td>
                           
                            <td><a style="padding: 0.6rem 2rem;" href="#" data-id="<?php echo $item->FeedBackId; ?>" data-toggle="modal" data-target="#exampleModal-3" class="btn btn-outline-danger btn-rounded  btn-fw btndelete"><i class="fa fa-trash-o">&nbsp;&nbsp;Delete</i></a></td>
                   ...
                   <div class="modal fade" id="exampleModal-3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-3" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>index.php/FeedBackController/Delete">
                        <div class="modal-body">
                          <p>Are You Sure Want To Permanently Remove This FeedBack ?</p>
