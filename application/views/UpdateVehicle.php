           ...
           <div class="col-md-3"></div>
            <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card-body">
                  ...
                  <h1 class="template-demo">Update Vehicle</h1>
                  </div>
                  <form id="Vehicleform" enctype="multipart/form-data" multiple="multiple"   class="forms-sample" method="post" action="<?php echo base_url(); ?>/index.php/VehicleController/update">
                  ...
                  <div class="form-group">
                      ...
                      <option><?php echo $Alltype[0]->Typename; ?></option>
                      <?php
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input value="<?php echo $data[0]->Userid; ?>" type="text" class="form-control"  name="txtUserName"  placeholder="User Name" />
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input value="<?php echo $data[0]->Vehiclename; ?>" type="text" class="form-control"  name="txtVehicleName"  placeholder="Vehicle Name" />
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select required="" class="form-control" id="txtSeats" name="txtSeats" value="<?php echo $data[0]->Seats; ?>">
                            <option><?php echo $data[0]->Seats; ?>
                              </option>
                              <option>2
                              </option>
                              <option>5
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input value="<?php echo $data[0]->Price; ?>" type="text" class="form-control"  name="txtPrice"  placeholder="Vehicle Per Day Price" />
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input value="<?php echo $data[0]->RCNo; ?>" type="text" class="form-control"  name="txtRcNo"  placeholder="Rc Book No." />
                  ...
                  <div class="form-group">
                        ...
                        <textarea value="<?php echo $data[0]->Descripation; ?>" class="form-control"  name="txtDescripation"  placeholder="Vehicle Descripation" ></textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                        <input value="<?php echo $data[0]->Vehicleimg; ?>" type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
                   ...
                   <div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                        <input value="<?php echo $data[0]->RCimg; ?>" type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Image">
                        <span class="input-group-append">
                          <button class="file-upload-browse btn btn-primary" type="button">Upload</button>
                        </span>
                      </div>
