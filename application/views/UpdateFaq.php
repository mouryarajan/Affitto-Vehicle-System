           ...
           <div class="col-md-3"></div>
            <div class="col-md-6 grid-margin stretch-card">
                ...
                <div class="card-body">
                  ...
                  <h1 class="template-demo"> Update FAQ</h1>
                  </div>
                  <form id="FaqForm" class="forms-sample" method="post" action="<?php echo base_url(); ?>/index.php/FaqController/Update">
                    <div class="form-group">
                      <label>FAQ Categerious</label>
                      <select class="form-control"  name="txtFaqCatName" >
                        <option><?php echo $FaqCatData[0]->FaqCatName; ?></option>
                        <?php
                        foreach($FaqCatData as $item)
                        {
                        ?>
                        <option value="<?php echo $FaqCatData[0]->FaqCatName; ?>"><?php echo $item->FaqCatName; ?> </option>
                        <?php } ?>
                      </select>
                       </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  value="<?php echo $FaqData[0]->Question; ?>" placeholder="Faq Image"  name="txtQuestion" />
                    </div>
                    <div class="form-group">
                      <label>FAQ Answer</label>
                      <input type="text" class="form-control" value="<?php echo $FaqData[0]->Answer; ?>"  placeholder="Faq answer"  name="txtAnswer" />
                    </div>
                    <button type="submit" class="btn btn-primary mr-2" name="btnadd">Update</button>
                   
                    <button href="<?php echo base_url(); ?>index.php/FaqController/LoadFaq/" class="btn btn-light">Back</button>
                    <?php 
