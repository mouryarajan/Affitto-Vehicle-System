...
<head>
  ...
  <title>AFFITTO - Agency Project</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            ...
            <div class="row">
              <div class="col-6">
                <h1 class="template-demo">Agency Details</h1>
              </div>
                  ...
                  <div class="table-responsive">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      {?>
                          <tr>
                            ...
                            <td><?php echo ucwords($item->AgencyName);?></td>
                            <td><?php echo ucwords($item->AgencyAddress); ?></td>
                            <td><a href="<?php echo base_url(); ?>index.php/UserController/Agencydetails/<?php echo $item->AgencyName; ?>" class="btn btn-outline-warning btn-rounded btn-fw"style="padding: 0.6rem 2rem;"><i class="fa fa-edit">&nbsp;&nbsp;Details</i></a></td>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url(); ?>index.php/UserController/AgencyDelete">
                        <div class="modal-body">
                          <p>Are You Sure Want To Permanently Remove This Agency ?</p>
