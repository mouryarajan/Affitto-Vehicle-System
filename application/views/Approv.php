          ...
          <div class="card">
            ...
            <?php } ?>
              ...
              Select Booking Status
                        ...
                        <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/BookingController/LoadAllBooking">All Booking Status</a>
                        <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/BookingController/LoadPending">Pending</a>
                        <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/BookingController/LoadApprov">Approv</a>
                        </div>
               ...
               <div class="table-responsive">
                    ...
                    <th>No</th>
                     ...
                     <tbody>
                      <?php
                        $count=1;
                        foreach($ApprovData as $item)
                      {?>
                          <tr>
                            <td><?php echo $count;$count++;?></td>
                          
                            <td><?php echo ucwords($item->ownername);?></td>
                            <td><?php echo ucwords($item->custname);?></td> 
                            <td><?php echo ucwords($item->versionname);?></td>
                            <td><?php echo ucwords($item->TotalPayment);?></td> 
                            <td><?php echo ucwords($item->TranscationNo);?></td> 
                            <td><?php echo ucwords($item->Status);?></td>            
                            
                           
                            <td>  <a href="<?php echo base_url(); ?>index.php/BookingController/LoadApprovDetails" class="btn btn-outline-warning btn-fw"><i class="fa fa-edit">Details</i></a></td>
                            </tr>
                      <?php
                      } 
                      ?>  
