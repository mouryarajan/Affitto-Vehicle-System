      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
            <div class="col-6">
              <h1 class="template-demo">Approve Vehicle Details</h1>
              </div>   
            <?php
            ...
            <div class="row">
                   ...
                   <a href="<?php echo base_url(); ?>index.php/VehicleController/LoadPending" class="btn btn-info btn-rounded btn-fw">
                   Pending
                             </a>
                    ...
                    <tr>
                     ...
                     <?php
                      ...
                      {?>
                        ...
                        <td>    <a style="padding: 0.6rem 2rem;" href="<?php echo base_url(); ?>index.php/VehicleController/LoadApprovDetails/<?php echo $item->VehicleId; ?>" class="btn btn-outline-success btn-rounded  btn-fw"><i class="fa fa-edit">&nbsp;Details</i></a></td>                      
                             <?php
                      } 
                      ?>  
                    </tbody>
